    ...
    return (
        <>
            <div
                ...
                <div className="mt-20 font-thin border-[.25px] border-zinc-300 py-2 px-4 rounded-full text-[.7rem] md:text-[.9rem] text-zinc-500 flex-center gap-2">
                ...
                <div className="mb-10 flex flex-col items-center">
                    ...
                    <h2 className="main-text text-[1.5rem] md:text-[2rem] text-center">
