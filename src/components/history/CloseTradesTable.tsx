...
type ClosedTrade = Trades & { closeDate: string; closeTime: string; result: string };
...
export const CloseTradesTable = ({ trades, startCapital, total }: CloseTradesTableProps) => {
    ...
    if (!trades || trades.length === 0) {
        return <div className="p-4 text-center text-zinc-500">No closed trades</div>;
    }
                        ...
                        <div className="col-span-4 max-md:col-span-4 text-center">
                            <div className="flex items-center justify-center gap-0.5">
                                {[...Array(5)].map((_, i) => (
                                    <MdStar
                                        key={i}
                                        className={`text-sm ${trade.rating && trade.rating > i ? "text-yellow-500" : "text-neutral-400"}`}
                                    />
                                ))}
                            </div>
                        </div>
                                    ...
                                    <HoverCardContent>
                                        <div className="flex flex-col gap-2">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <h1 className="text-neutral-400">@tradejournal.one</h1>
                                            </div>
