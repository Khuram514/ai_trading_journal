    ...
    return (
        <div className="flex-1 overflow-auto">
            ...
            <div className="grid grid-cols-27 max-md:grid-cols-20 gap-1 p-2 items-center border-b bg-muted/50 font-medium text-sm">
                ...
                <div className="col-span-4 max-md:hidden text-center">Open price</div>
                ...
                <div className="col-span-2 max-md:col-span-1 text-center">Close</div>
            </div>

            {trades.map((trade) => (
                <div
                    key={trade.id}
                    className="grid grid-cols-27 max-md:grid-cols-20 gap-1 p-2 border-b hover:bg-muted/30 transition-colors items-center"
                >
                    {/* Symbol */}
