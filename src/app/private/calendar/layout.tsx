...
export default function CalendarLayout({ children }: { children: ReactNode }) {
    ...
    return (
        <div className="flex flex-col h-full">
            <div className="px-3 md:px-6 flex items-center justify-between py-4 md:py-2 border-b border-zinc-200 max-md:flex-col gap-4">
                <div className="flex items-center justify-between max-md:w-full md:flex-center gap-4 md:gap-5">
                    <Dialog
                        open={!!isDialogOpen["any"]}
                        onOpenChange={(open) =>
                            dispatch(
                                setIsDialogOpen({ key: "any", value: open })
                            )
                        }>
                    ...
                    <CustomButton onClick={handleReturnToToday} isBlack={false}>
                        Today
                    </CustomButton>
