    ...
    return (
        <div
            ...
            <div className="flex max-md:flex-col gap-4 md:gap-0 items-center justify-between">
                <span className="bg-primary text-zinc-500 text-[.9rem] px-4 py-2 border border-gray-200 rounded-lg">
            ...
            <div className="grid grid-cols-3 grid-rows-3 gap-x-8 gap-y-8 pb-[24px] lg:pb-0">
                {paginatedReports ? (
                    paginatedReports?.map((report) => (
                        <Link
                            className="max-h-[170px] col-span-3 lg:col-span-1 row-span-1 border border-gray-200 md:hover:border-gray-400 duration-200 rounded-2xl py-4 px-6 flex flex-col gap-2 shadow-sm"
